 ...
 if ( (keyCode == 38 || keyCode == 40)) { 
    ...
    function productDisplay(ctl) {
      ...
      $("#location").val($(cols[5]).text());
      $("#type").val($(cols[6]).text());
   ...
   $('#table2 tr').each(function(){
    ...
    var randomNumber = Math.floor(Math.random() * 100000);
      ...
      var ret =
        ...
        "<td class='item_date"+newid+"'>" + $("#location").val(); + "</td>" +
        "<td class='unit_price"+newid+"'>" + $("#type").val(); + "</td>" +
...
var comt=0;
    ...
    if(comt!=1){
        ...
        "<td class='item_date"+newid+"'>" + "" + "</td>" +
        "<td class='unit_price"+newid+"'>" +"" + "</td>" +
